...
import 'package:thisjowi/screens/onboarding/country_map_screen.dart';
  ...
  Widget _buildMapPromptPage() {
    return Padding(
      ...
      child: Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
          const Icon(Icons.public, size: 80, color: AppColors.secondary),
          const SizedBox(height: 24),
          Text(
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: isSelected ? AppColors.primary : AppColors.text.withOpacity(0.1),
            width: 2,
          ),
        ),
        child: Row(
